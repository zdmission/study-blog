...
module.exports = function createBaseConfig ({
  ...
  console.log(JSON.stringify(require.resolve('./markdownLoader')))
  ...
  function applyVuePipelineImages (rule) {
    rule
        .use('url-loader')
        .loader('url-loader')
        .options({
  ...
  const imagesModule = config.module
  .rule('images')
    .test(/\.(png|jpe?g|gif|svg|ico)(\?.*)?$/)

  applyVuePipelineImages(imagesModule)
  // console.log(imagesModule.use('image-webpack-loader'))
  // config.module
  //   .rule('images')
  //     .test(/\.(png|jpe?g|gif)(\?.*)?$/)
  //     .use('url-loader')
